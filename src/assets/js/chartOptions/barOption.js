export default function ({ title = '', series_data = [], xAxis_data = [], yAxis_name = '', title_offset = 'center', title_top = '10px', title_color = '#fff', series_color = ['#ff8b35'], legend_data = [], legend_show = true, legend_right = '10%' } = {}) {
